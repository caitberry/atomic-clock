...
N=formattedData$N
# x.t=formattedData$x.t[1:3000]
# t.vec=formattedData$t.vec[1:3000]
# N=length(x.t)#formattedData$N
...
specAVARest=mtse$AVAR_spec(spectral_est = myDatSpecEst$spec.hat,taus = taus,calcUnc = T,Cov.mat = myDatSpecEst$Cov.mat)
