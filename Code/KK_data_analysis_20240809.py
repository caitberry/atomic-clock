...
data_ErYb = pd.concat(
    [
        open_ErYb_data(
            os.path.join("..", "data", "20240716", "240716_Deglitched_ErYb_only.dat")
        ),
    ],
    ignore_index=True,
)
data_TiSa = pd.concat(
    [
        open_TiSa_data(
            os.path.join("..", "data", "20240716", "240716_Deglitched_TiS_only.dat")
        )
    ],
    ignore_index=True,
)
...
shift_data_Sr = pd.concat(
    [
        open_shiftfile_Sr(
            os.path.join("..", "data", "20240716", "20240716_Sr_Freq_Shifts_1.dat")
        ),
        open_shiftfile_Sr(
            os.path.join("..", "data", "20240716", "20240716_Sr_Freq_Shifts_2.dat")
        ),
        open_shiftfile_Sr(
            os.path.join("..", "data", "20240716", "20240716_Sr_Freq_Shifts_3.dat")
        ),
        open_shiftfile_Sr(
            os.path.join("..", "data", "20240716", "20240716_Sr_Freq_Shifts_4.dat")
        ),
    ],
    ignore_index=True,
)
shift_data_Yb = pd.concat(
    [
        open_shiftfile_Yb(
            os.path.join("..", "data", "20240716", "20240716_Yb_Freq_Shifts.txt")
        )
    ],
    ignore_index=True,
)
