############################################################################
############################################################################
### simulate data from Gauss+Gauss
############################################################################
############################################################################
simulateData=function(N,mu,tau,lb,ub){
  
  lambda=rnorm(N,0,tau) # Day effects
  ...
  dat=data.frame(Day=as.factor(1:N),
                 x=x,
                 u=sigma)
  return(dat)
}
