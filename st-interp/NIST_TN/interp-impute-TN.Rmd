...
## Report Organization 
The next section presents some background information and an example to provide context for the problem at hand. Section 3 discusses the initial necessary data exploration steps, Section 4 covers interpolation methods for handling multiple, misaligned data sets, and Section 5 concludes with a summary and by reiterating the steps needed to produce a coherent final data set for estimation and inference of a clock ratio time series. 
...
[Add note of caution about how keeping missing data until end is not advisable.] <-- re-think this.. 

[Add discussion on data deemed poor quality (IS_GOOD variable)] 
