...
[Background on existing approaches for combining time series]

[Background on existing methods for univariate time series imputation]

[Background on existing work mapping low frequency series to high frequency one.] 
